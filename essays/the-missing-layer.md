...
Enterprise data is a different animal entirely. It is not a record of something that happened out in the world. It *is* the live state of the business, and writing to it *changes the business*. When a system marks an order *shipped*, releases a work order, approves a payment, or moves a lot from quarantine to available, that write is not an observation. It's an act, with consequences in inventory, in cash, in obligation, in compliance. The data is acted upon, not merely consulted.
