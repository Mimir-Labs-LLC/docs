...
Yggdrasil uses subscription pricing with three bundled tiers (Starter at $800/month, Professional at $1,900/month, Enterprise at $4,800/month) and an a-la-carte option where individual modules are priced between $265 and $490 per month depending on complexity. The bundles include seat allocations — 5, 15, and unlimited respectively — with additional seats at $10/user/month beyond the allocation. This structure avoids pure per-seat pricing, which in manufacturing contexts tends to discourage organizations from giving system access to shop floor workers, warehouse staff, and quality inspectors. The per-seat overage rate is low enough to be incidental rather than load-bearing.

One-time implementation fees accompany each subscription: $6,000 to $25,000 for bundles, $2,000 to $5,000 per module a la carte. These cover discovery, data migration, integration setup, role-based training, and 30 days of go-live support. A location-based fee applies for implementation sites more than 50 miles from the company's base in Harrisburg, PA, covering travel costs at prevailing rates.

Each plan includes a monthly API call threshold (175,000 for Starter up to 1,500,000 for Enterprise) with a $0.002/call overage surcharge. Billing cycle discounts of 3% (quarterly) and 8% (annual) apply to recurring subscription fees. An introductory pricing period through May 2026 offers 15% off a-la-carte recurring fees and $1,000 off per-module implementation fees.
